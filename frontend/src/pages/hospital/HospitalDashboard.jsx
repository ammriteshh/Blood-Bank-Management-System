  ...
  useEffect(() => {
    const fetchHospitalData = async () => {
      try {
        ...
        const profileRes = await fetch(`${API_ENDPOINTS.FACILITY}/profile`, {
        ...
        // Fetch blood stock
        const stockRes = await axios.get(`${API_ENDPOINTS.HOSPITAL}/blood/stock`, {
          headers: { Authorization: `Bearer ${token}` },
        });

        // Fetch blood requests
        const requestsRes = await axios.get(`${API_ENDPOINTS.HOSPITAL}/blood/requests`, {
          headers: { Authorization: `Bearer ${token}` },
        });
